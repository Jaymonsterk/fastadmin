...
return [
    ...
    'User Manage' => '用户管理',
    'User List' => '会员管理',
    'Cash withdrawal bank card Manage' => '用户银行卡管理',
    'Mass user message Manage' => '用户消息管理',
    'User recharge list' => '用户充值列表',
    'User withdrawal list' => '用户提现列表',
    'Order Manage' => '订单管理',
    'User level Manage' => '用户等级管理',
    'Task order list' => '任务订单列表',
    'Signin activity list' => '签到活动列表',
    'Invite to make a list of rewards' => '邀请做单奖励列表',
    'Invite recharge reward list' => '邀请充值奖励列表',
    'Registration event list' => '注册活动列表',
    'Yu\'e Bao activities list' => '余额宝活动列表',

    'config Manage' => '配置管理',
    'Homepage carousel config' => '首页轮播配置',
    'Activity banner config' => '活动banner图配置',
    'User level config' => '用户等级配置',
    'Tripartite Top-up config' => '三方充值配置',
    'Task commodity config' => '任务商品配置',
    'Sign-in activity config' => '签到活动配置',
    'Invitation to do order reward config' => '邀请做单配置',
    'Invite recharge reward config' => '邀请充值配置',
    'System parameter config' => '平台参数配置',
    'Yu\'ebao config' => '余额宝配置',


    'Report Manage' => '报表管理',
    'Data overview' => '数据总览',
    'User structure report' => '用户结构日报表',
    'User recharge daily report' => '充值日报表',
    'User withdrawal daily report' => '提现日报表',
    'User task daily report' => '任务日报表',

    'Log Manage' => '日志管理',
    'Admin operation log' => '管理员操作日志',
    'User funds log' => '会员资金日志',
    'User operation log' => '用户操作日志',
