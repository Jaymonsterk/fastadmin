define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/order_user_other/index' + location.search,
                    // add_url: 'order/order_user_other/add',
                    // edit_url: 'order/order_user_other/edit',
                    // del_url: 'order/order_user_other/del',
                    // multi_url: 'order/order_user_other/multi',
                    //import_url: 'order/order_user_other/import',
                    table: 'order_user_other',
                }
            });
