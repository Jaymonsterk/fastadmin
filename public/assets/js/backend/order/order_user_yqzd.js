define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/order_user_yqzd/index' + location.search,
                    // add_url: 'order/order_user_yqzd/add',
                    // edit_url: 'order/order_user_yqzd/edit',
                    // del_url: 'order/order_user_yqzd/del',
                    // multi_url: 'order/order_user_yqzd/multi',
                    //import_url: 'order/order_user_yqzd/import',
                    table: 'order_user_yqzd',
                }
            });
